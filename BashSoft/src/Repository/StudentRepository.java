...
public class StudentRepository {
    ...
    private static void readData(String fileName) throws IOException {
        ...
        for (String line : lines) {
            ...
            if(!line.isEmpty() && matcher.find()) {
                ...
                if(mark >= 0 && mark <= 100) {
                    studentsByCourse.putIfAbsent(course, new LinkedHashMap<>());
    ...
    public static void printFilteredStudents(String course,
                                             String filter, Integer numberOfStudents){
        if(!isQueryForCoursePossible(course)){
            return;
        }
    ...
    public static void printOrderedStudents(String course,
                                             String compareType, Integer numberOfStudents){
        if(!isQueryForCoursePossible(course)){
            return;
        }
